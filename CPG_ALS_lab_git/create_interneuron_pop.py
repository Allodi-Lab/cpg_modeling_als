...
class interneuron_population():
    ...
    def create_interneuron_population(self,pop_type,self_connection,firing_behavior,pop_size,input_type):
        ...
        if firing_behavior == 'tonic':
            ...
            self.white_noise = nest.Create("noise_generator",netparams.noise_params_tonic_fb) if input_type=='sensory_feedback' else nest.Create("noise_generator",netparams.noise_params_tonic)                       
