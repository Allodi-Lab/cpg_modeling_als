...
#test_names=("P0_D1" "P0_D2" "P45_D1" "P45_D2" "P63_D1" "P63_D2" "P112_D1" "P112_D2") #run all
#test_names=("P45_D1" "P45_D2" "P63_D1" "P63_D2" "P112_D1" "P112_D2")   #run only disease timepoints
test_names=("P45_D1" "P45_D2")
